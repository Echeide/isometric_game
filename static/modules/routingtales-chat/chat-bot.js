...
var _isInit, _updateColor, updateColor_fn, _isInit2, _onTransitionend, onTransitionend_fn, _isInit3, _messages, _addMessages, addMessages_fn, _addMessage, addMessage_fn, _isInit4, _isInit5, _options, _canClick, _onClick, onClick_fn, _addBtns, addBtns_fn, _isInit6, _updatePicture, updatePicture_fn, _isInit7, _updateColor2, updateColor_fn2, _isInit8, _searchResultItem, _updateDistance, updateDistance_fn, _onGeolocationError, onGeolocationError_fn, _isInit9, _results, _addResults, addResults_fn, _addResultElements, addResultElements_fn, _isInit10, _queries, _makeQueries, makeQueries_fn, _makeQuery, makeQuery_fn, _getRequest, getRequest_fn, _postRequest, postRequest_fn, _extractResults, extractResults_fn, _isInit11, _chatNode, _chatConf, _instancesCount, _createNodeElements, createNodeElements_fn, _addAvatar, addAvatar_fn, _addNodeMessages, addNodeMessages_fn, _makeNodeSearch, makeNodeSearch_fn, _addNodeOptions, addNodeOptions_fn, _onChatOptionClick, onChatOptionClick_fn, _dispatchAdd_home, dispatchAdd_home_fn, _setResponse, setResponse_fn, _getNodeMessages, getNodeMessages_fn, _appendContent, appendContent_fn, _speechRecognition, _stopRecognition, stopRecognition_fn, _isInit12, _message, _initComponent, initComponent_fn, _isInit13, _recognitionEnabled, _speech, _disabled, _updateDisabled, updateDisabled_fn, _toggleRecognition, toggleRecognition_fn, _enableRecognition, enableRecognition_fn, _disableRecognition, disableRecognition_fn, _isInit14, _chatConf2, _speechRecognitionSupport, _setupInputForm, setupInputForm_fn, _onSubmit, onSubmit_fn, _onSpeechResults, onSpeechResults_fn, _disableInput, disableInput_fn, _validateInputString, validateInputString_fn, _enableInput, enableInput_fn, _updateSendBtnState, updateSendBtnState_fn, _submitInput, submitInput_fn, _addInputMessage, addInputMessage_fn, _addResults2, addResults_fn2, _clearChatInput, clearChatInput_fn, _updateBySrc, updateBySrc_fn, _clearHistoric, clearHistoric_fn, _autoScroll, autoScroll_fn, _addChatNode, addChatNode_fn, _onAdd_home, onAdd_home_fn;
var styles$d = ":host{display:flex;flex-direction:column;height:100%;font-size:18px;font-family:Open Sans,sans-serif;font-family:Roboto,sans-serif}.historic{flex:1 1 0;overflow:auto}.historic-content{min-height:100%;display:flex;flex-direction:column;justify-content:flex-end}.input-form{position:relative;display:grid;padding:.5rem;box-sizing:border-box;height:60px;background-color:#fff}.chat-input{padding-left:45px;padding-right:85px;border:1px solid #E4E4E4;border-radius:10px;outline:none;font-size:18px}.chat-input::-ms-clear,.chat-input::-ms-reveal{display:none;width:0;height:0}.chat-input::-webkit-search-decoration,.chat-input::-webkit-search-cancel-button,.chat-input::-webkit-search-results-button,.chat-input::-webkit-search-results-decoration{display:none}.clear-btn{--size: 40px;position:absolute;top:calc(32px - var(--size) * .5);left:12px;width:var(--size);height:var(--size);background-color:transparent;border:none;cursor:pointer}.send-btn{--size: 40px;position:absolute;top:calc(30px - var(--size) * .5);right:48px;width:var(--size);height:var(--size);background-color:transparent;border:none;cursor:pointer}.send-btn:disabled{opacity:.5}.results-container{padding-left:70px}speech-input{position:absolute;z-index:2;top:12.5px;right:13px}\n";
var styles$c = ":host{display:inline-block}.content{display:contents}\n";
...
var styles$b = ':host{display:flex;overflow:hidden}.avatar{width:70px}chat-avatar{opacity:0;animation-duration:.4s;animation-fill-mode:forwards;animation-iteration-count:1}chat-avatar.appear{animation-name:chat-avatar-appear}.content{flex:1 1 0;padding-top:.5rem}.response-container{padding:0 1rem .5rem;display:flex;justify-content:flex-end;overflow:hidden}.response{position:relative;display:inline-block;padding:.5rem 1rem;background-color:var(--color-dominant, blue);color:var(--color-over-primary, #fff);opacity:0;transform:translate(50px);animation-name:response-added;animation-fill-mode:forwards;animation-iteration-count:1;animation-duration:.4s;animation-delay:.4s;border-radius:var(--btn-border-radius, 3px)}.response:before{content:"";display:block;position:absolute;top:13px;right:-10px;width:0;height:0;border-style:solid;border-width:7.5px 0 7.5px 10px;border-color:transparent transparent transparent var(--color-primary, blue)}@keyframes response-added{0%{transform:translate(50px);opacity:0}to{transform:translate(0);opacity:1}}@keyframes chat-avatar-appear{0%{opacity:0}to{opacity:1}}\n';
var styles$a = ":host{display:block}.container{position:relative;height:0;transition:height .4s}.content{position:absolute;left:0;top:50%;width:100%;transform:translateY(-50%)}\n";
...
var styles$8 = ":host{font-size:18px;font-style:italic;font-weight:700;padding:.5rem;background-color:#fff;color:var(--color-dominant, blue);border:1px solid var(--color-dominant, blue);display:inline-flex;justify-content:center;align-items:center;cursor:pointer;border-radius:var(--btn-border-radius, 3px);transition-property:background-color,color;transition-duration:.2s}:host(:hover){background-color:var(--color-dominant, blue);color:#fff}\n";
...
var styles$7 = ":host{display:block;overflow:hidden;padding:.5rem 1rem}.btns-grid{display:grid;padding:1rem;gap:.5rem;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));box-sizing:border-box;background-color:#fff;box-shadow:0 2px 4px #0003;border-radius:3px;overflow:hidden;opacity:0;animation-duration:.4s;animation-iteration-count:1;animation-fill-mode:forwards}.btns-grid.appear{animation-name:grid-appear}.btns-grid.appear chat-btn{animation-name:chat-btn-appear}chat-btn{opacity:0;transform:translateY(-10px);animation-duration:.4s;animation-iteration-count:1;animation-fill-mode:forwards}chat-btn:nth-child(1){animation-delay:0ms}chat-btn:nth-child(2){animation-delay:50ms}chat-btn:nth-child(3){animation-delay:.1s}chat-btn:nth-child(4){animation-delay:.15s}chat-btn:nth-child(5){animation-delay:.2s}chat-btn:nth-child(6){animation-delay:.25s}chat-btn:nth-child(7){animation-delay:.3s}chat-btn:nth-child(8){animation-delay:.35s}chat-btn:nth-child(9){animation-delay:.4s}chat-btn:nth-child(10){animation-delay:.45s}chat-btn:nth-child(11){animation-delay:.5s}chat-btn:nth-child(12){animation-delay:.55s}chat-btn:nth-child(13){animation-delay:.6s}chat-btn:nth-child(14){animation-delay:.65s}chat-btn:nth-child(15){animation-delay:.7s}chat-btn:nth-child(16){animation-delay:.75s}chat-btn:nth-child(17){animation-delay:.8s}chat-btn:nth-child(18){animation-delay:.85s}chat-btn:nth-child(19){animation-delay:.9s}chat-btn:nth-child(20){animation-delay:.95s}chat-btn:nth-child(21){animation-delay:1s}chat-btn:nth-child(22){animation-delay:1.05s}chat-btn:nth-child(23){animation-delay:1.1s}chat-btn:nth-child(24){animation-delay:1.15s}chat-btn:nth-child(25){animation-delay:1.2s}@keyframes grid-appear{0%{opacity:0}to{opacity:1}}@keyframes chat-btn-appear{0%{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}@keyframes fadeOut{0%{opacity:1;transform:scale(1)}to{opacity:0;transform:scale(0.95)}}\n";
class ChatOptions extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `<style>${styles$7}</style>`;
...
onClick_fn = function (chatOption) {
  ...
  // Hacer que las opciones desaparezcan visualmente
  const btnsGrid = this.shadowRoot.querySelector(".btns-grid");
  if (btnsGrid) {
    btnsGrid.style.animation = "fadeOut 0.3s ease-out forwards";
    btnsGrid.addEventListener("animationend", () => {
      // Ocultar completamente el elemento después de la animación
...
var styles$6 = ":host{--size: 70px;display:block;width:var(--size);height:var(--size);padding:.5rem 0}.picture{display:block;width:var(--size);height:var(--size);object-fit:contain}\n";
class ChatAvatar extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `<style>${styles$6}</style>`;
...
var styles$5 = ":host{display:block;overflow:hidden}\n";
var styles$4 = ":host{display:block;overflow:hidden}.search-results{display:flex;flex-direction:column;gap:.5rem;padding:.5rem 1rem}search-result-item{transform:translate(-50px);opacity:0}search-result-item.appear{animation-name:search-result-item-animation;animation-duration:.4s;animation-fill-mode:forwards;animation-iteration-count:1}search-result-item.appear:nth-child(1){animation-delay:0ms}search-result-item.appear:nth-child(2){animation-delay:.1s}search-result-item.appear:nth-child(3){animation-delay:.2s}search-result-item.appear:nth-child(4){animation-delay:.3s}search-result-item.appear:nth-child(5){animation-delay:.4s}search-result-item.appear:nth-child(6){animation-delay:.5s}search-result-item.appear:nth-child(7){animation-delay:.6s}search-result-item.appear:nth-child(8){animation-delay:.7s}search-result-item.appear:nth-child(9){animation-delay:.8s}search-result-item.appear:nth-child(10){animation-delay:.9s}search-result-item.appear:nth-child(11){animation-delay:1s}search-result-item.appear:nth-child(12){animation-delay:1.1s}search-result-item.appear:nth-child(13){animation-delay:1.2s}search-result-item.appear:nth-child(14){animation-delay:1.3s}search-result-item.appear:nth-child(15){animation-delay:1.4s}search-result-item.appear:nth-child(16){animation-delay:1.5s}search-result-item.appear:nth-child(17){animation-delay:1.6s}search-result-item.appear:nth-child(18){animation-delay:1.7s}search-result-item.appear:nth-child(19){animation-delay:1.8s}search-result-item.appear:nth-child(20){animation-delay:1.9s}search-result-item.appear:nth-child(21){animation-delay:2s}search-result-item.appear:nth-child(22){animation-delay:2.1s}search-result-item.appear:nth-child(23){animation-delay:2.2s}search-result-item.appear:nth-child(24){animation-delay:2.3s}search-result-item.appear:nth-child(25){animation-delay:2.4s}search-result-item.appear:nth-child(26){animation-delay:2.5s}search-result-item.appear:nth-child(27){animation-delay:2.6s}search-result-item.appear:nth-child(28){animation-delay:2.7s}search-result-item.appear:nth-child(29){animation-delay:2.8s}search-result-item.appear:nth-child(30){animation-delay:2.9s}search-result-item.appear:nth-child(31){animation-delay:3s}search-result-item.appear:nth-child(32){animation-delay:3.1s}search-result-item.appear:nth-child(33){animation-delay:3.2s}search-result-item.appear:nth-child(34){animation-delay:3.3s}search-result-item.appear:nth-child(35){animation-delay:3.4s}search-result-item.appear:nth-child(36){animation-delay:3.5s}search-result-item.appear:nth-child(37){animation-delay:3.6s}search-result-item.appear:nth-child(38){animation-delay:3.7s}search-result-item.appear:nth-child(39){animation-delay:3.8s}search-result-item.appear:nth-child(40){animation-delay:3.9s}@keyframes search-result-item-animation{0%{transform:translate(-50px);opacity:0}to{transform:translate(0);opacity:1}}\n";
var styles$3 = ":host{display:block}.content{display:flex;gap:1rem;padding:.75rem 1rem;background-color:#fff;box-shadow:0 2px 4px #0003;border-radius:3px}.title{flex:1 1 0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\n";
...
var styles$2 = ":host{display:inline-block;width:20px;height:20px}.lds-ring{display:block;position:relative;width:100%;height:100%}.lds-ring div{box-sizing:border-box;display:block;position:absolute;width:80%;height:80%;margin:10%;border-radius:50%;animation:lds-ring 1.2s cubic-bezier(.5,0,.5,1) infinite;border-width:10%;border-style:solid;border-color:var(--color, #fff) transparent transparent transparent}.lds-ring div:nth-child(1){animation-delay:-.45s}.lds-ring div:nth-child(2){animation-delay:-.3s}.lds-ring div:nth-child(3){animation-delay:-.15s}@keyframes lds-ring{0%{transform:rotate(0)}to{transform:rotate(360deg)}}\n";
class LoadingIcon extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `
        ...
        `;
    __privateMethod(this, _updateColor2, updateColor_fn2).call(this);
  }
  attributeChangedCallback(attName) {
    if (attName === "color") {
      __privateMethod(this, _updateColor2, updateColor_fn2).call(this);
...
updateColor_fn2 = function () {
  if (!__privateGet(this, _isInit7)) {
    return;
  }
  const ldsRing = this.shadowRoot.querySelector(".lds-ring");
  ldsRing.style.setProperty("--color", this.getAttribute("color"));
};
...
class SearchResultItem extends HTMLElement {
  constructor(searchResultItem) {
    ...
    __privateAdd(this, _onGeolocationError);
    __privateAdd(this, _isInit8, false);
    __privateAdd(this, _searchResultItem, void 0);
    __privateSet(this, _searchResultItem, searchResultItem);
    this.attachShadow({ mode: "open" });
  }
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `
            ...
            <div class="content">
                <div class="title">
                    <a href="${__privateGet(this, _searchResultItem).externalLink}" target="_blank">${__privateGet(this, _searchResultItem).title}</a>
                </div>
                <div class="distance">
                    <loading-icon color="#666"></loading-icon>
                </div>
            </div>
        `;
...
_searchResultItem = new WeakMap();
_updateDistance = new WeakSet();
updateDistance_fn = function () {
  const distanceElement = this.shadowRoot.querySelector(".distance");
  if (!__privateGet(this, _searchResultItem).coordinates) {
    clearElement(distanceElement);
    return;
  }
  window.navigator.geolocation.getCurrentPosition((position) => {
    const distance = haversineDistance_1(position.coords, __privateGet(this, _searchResultItem).coordinates);
    distanceElement.textContent = `${formatDistance(distance / 1e3)} Km`;
  }, (error) => __privateMethod(this, _onGeolocationError, onGeolocationError_fn).call(this, error), {
    enableHighAccuracy: true
  });
};
_onGeolocationError = new WeakSet();
onGeolocationError_fn = function (error) {
  var _a;
  console.error(error);
  (_a = this.shadowRoot.querySelector(".distance")) == null ? void 0 : _a.remove();
};
...
class SearchResults extends HTMLElement {
  constructor(results) {
    ...
    __privateAdd(this, _addResultElements);
  ...
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML = `
        ...
        `;
    __privateMethod(this, _addResults, addResults_fn).call(this);
  }
}
_isInit9 = new WeakMap();
_results = new WeakMap();
_addResults = new WeakSet();
addResults_fn = async function () {
  await __privateMethod(this, _addResultElements, addResultElements_fn).call(this);
  this.shadowRoot.querySelectorAll("search-result-item").forEach((searchResultItem) => {
    searchResultItem.classList.add("appear");
  });
  this.dispatchEvent(new CustomEvent("component_ready"));
};
_addResultElements = new WeakSet();
addResultElements_fn = function () {
  return new Promise((resolve) => {
    const searchResults = document.createElement("div");
    const smoothResize = new SmoothResize();
    smoothResize.addEventListener("resizecompleted", () => resolve(), { once: true });
    searchResults.classList.add("search-results");
    searchResults.append(...__privateGet(this, _results).map((result) => new SearchResultItem(result)));
    smoothResize.append(searchResults);
    this.shadowRoot.append(smoothResize);
  });
};
...
class SearchElement extends HTMLElement {
  constructor(queries) {
    ...
    __privateAdd(this, _extractResults);
...
makeQueries_fn = async function () {
  const results = await Promise.all(__privateGet(this, _queries).map((query) => __privateMethod(this, _makeQuery, makeQuery_fn).call(this, query)));
  await new Promise((resolve) => {
    const searchResults = new SearchResults(results.flat());
    searchResults.addEventListener("component_ready", () => resolve(), { once: true });
    this.shadowRoot.append(searchResults);
  });
  this.dispatchEvent(new CustomEvent("component_ready"));
};
_makeQuery = new WeakSet();
makeQuery_fn = async function (query) {
  const fetchMethods = {
    "get": () => __privateMethod(this, _getRequest, getRequest_fn).call(this, query),
    "post": () => __privateMethod(this, _postRequest, postRequest_fn).call(this, query)
  };
  if (!fetchMethods[query.method]) {
    throw new Error("M\xE9todo de query no soportado.");
  }
  const response = await fetchMethods[query.method]();
  if (!response.ok) {
    throw new Error("Ha ocurrido un error al efectuar la consulta.");
  }
  const content = await response.json();
  return __privateMethod(this, _extractResults, extractResults_fn).call(this, content, query.resultTemplate);
};
_getRequest = new WeakSet();
getRequest_fn = function (query) {
...
_extractResults = new WeakSet();
extractResults_fn = function (data, resultTemplate) {
  const results = [];
  ...
  for (const key of keys) {
    ...
    const replacements = template.match(/\{[^\}]+\}/g).map((match) => {
      const query = match.substring(1, match.length - 1);
      const results2 = jsonpath.query(data, query);
  ...
  for (let i = 0; i < numItems; i++) {
    ...
    if (queriesMap.lon && queriesMap.lat) {
      result.coordinates = {
        lon: queriesMap.lon(i),
        lat: queriesMap.lat(i)
      };
    }
    results.push(result);
  }
...
addNodeOptions_fn = async function () {
  if (!__privateGet(this, _chatNode).options?.length) {
    return;
  }
...
class SpeechInput extends HTMLElement {
  constructor() {
    ...
    __privateAdd(this, _isInit13, false);
  ...
  connectedCallback() {
    if (__privateGet(this, _isInit13)) {
      return;
    }
    __privateSet(this, _isInit13, true);
    this.shadowRoot.innerHTML = `
            <style>${styles}</style>
            <button type="button">
...
class ChatBot extends HTMLElement {
  constructor() {
    ...
    __privateAdd(this, _addResults2);
    ...
    __privateAdd(this, _isInit14, false);
  ...
  connectedCallback() {
    if (__privateGet(this, _isInit14)) {
      return;
    }
    __privateSet(this, _isInit14, true);
    const shadowRoot = this.shadowRoot;
    let innerHTML = `
...
submitInput_fn = async function (stringQuery) {
  ...
  try {
    ...
    const { companies, article } = await response.json();
    if (companies.length === 0 && !article) {
    ...
    if (article) {
      await chatNode.addMessages(article.content);
    } else {
    ...
    const results = companies.map(({ id, image, title, coordinates }) => ({
      image,
      title,
      coordinates,
      externalLink: __privateGet(this, _chatConf2).companyLinkTemplate.replace("{companyId}", id)
    }));
    await __privateMethod(this, _addResults2, addResults_fn2).call(this, results);
...
_addResults2 = new WeakSet();
addResults_fn2 = function (results) {
  return new Promise((resolve) => {
    const resultsContainer = document.createElement("div");
    const resultsElement = new SearchResults(results);
    resultsContainer.classList.add("results-container");
    resultsElement.addEventListener("component_ready", () => resolve(), { once: true });
