...
export interface CharacterPack {image:string;variants?:Record<string,string>;frameWidth:number;frameHeight:number;anchor:[number,number];directions:Facing[];animations:Record<ActorPose,CharacterClip>}
