<script lang="ts">
 ...
 import { World, parseScene, visualCatalog, type WorldScene, type WorldEntity, type WorldAdapter, type WorldEditor, type Facing, type TileKind, type Cell } from '@isometrico/world';
 import { insertEntity, moveEntity, flipEntity, paintTiles } from '$lib/demo/editor';
 import { office, outdoors } from '$lib/demo/scenes';
 import { ArrowLeft, Download, Upload, Plus, Trash2, Undo2, Play, Pencil, Check } from 'lucide-svelte';
 ...
 function ready(){if(restoreCanvasFocus){canvasHost?.querySelector<HTMLElement>('[role=application]')?.focus({preventScroll:true});restoreCanvasFocus=false;}}
